...
const Pricing = () => {
  return (
    <div className='max-w-7xl mx-auto container flex p-6 justify-center flex-col items-center'>
            <h1 className='text-2xl text-center sm:text-3xl md:-text-4xl font-bold max-w-2xl'>
                One tool for your whole company. Free for teams to try.
            </h1>
            <p className='uppercase opacity-70'>TRUSTED BY TEAMAS AT</p>
